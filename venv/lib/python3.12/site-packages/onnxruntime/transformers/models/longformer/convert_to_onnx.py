...
# Then run "python create_table.py install" in ./torch_extensions directory. If your python version is not 3.8, you will need
...
#   cd ./torch_extensions
#   rm -rf build
#   python create_table.py install
#   cd ..
...
# TODO: search the directory to find correct output filename of "python create_table.py install" when python version is not 3.8
